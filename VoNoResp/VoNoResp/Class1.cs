...
// Below is some DllImport and other shits
{
    public class Class1
    {
        [DllImport("gdi32.dll")]
        ...
        public static void Main()
        {
            ...
            int left = Screen.PrimaryScreen.Bounds.Left, right = Screen.PrimaryScreen.Bounds.Right, top = Screen.PrimaryScreen.Bounds.Top;
            uint[] rndclr = { 0xff0000, 0xff4000, 0xff8000, 0xffbf00, 0xffff00, 0xbfff00, 0x80ff00, 0x40ff00, 0x00ff00, 0x00ff40, 0x00ff80, 0x00ffbf, 0x00ffff, 0x00bfff, 0x0080ff, 0x0040ff, 0x0000ff, 0x4000ff, 0x8000ff, 0xbf00ff, 0xff00ff, 0xff00bf, 0xff0080, 0xff0040, 0xff0000 };
            while (true)
            {
                r = new Random();
                ...
                byte[] bits = { 0x3, 0x81, 0xc0, 0x60, 0x30, 0x18, 0xc, 0x6 };
                IntPtr bitmap = CreateBitmap(8, 4, 1, 1, bits);
                ...
                DeleteObject(Brush);
                DeleteDC(hdc);
                Thread.Sleep(4000); // 4000 - Default
            }
        }
    }
}
